...
namespace kernel {
    ...
    void execute_matrix_multiply_kernel_async(const double *a, const double *b, double *c, const unsigned int n, const int stream, const int device);
    void syncronize(const int device);
    void reset(const int device);
    void create_streams(const int num_streams);
